...
#       ubuntu 24.04
#
# rtabmap_ros_my/launch/foxbot_nav2_oak-d_depth_gps-test.launch.py
#
...
#   $ ros2 launch rtabmap_ros_my foxbot_nav2_oak-d_depth_gps-test.launch.py SBC:=true
#
...
#   or
#   2) PC2:=true 
#    $ ros2 launch rtabmap_ros_my foxbot_nav2_oak-d_depth_gps-test.launch.py PC2:=true
#
...
def generate_launch_description():
    ...
    PC2       = LaunchConfiguration('PC2')
    NAV2       = LaunchConfiguration('NAV2')

    auto_exp       = LaunchConfiguration('auto_exp')
    sensIso        = LaunchConfiguration('sensIso')
    expTime        = LaunchConfiguration('expTime')
    ...
    declare_use_sim_time_cmd = DeclareLaunchArgument('use_sim_time',default_value='false', description='sim time.')
    declare_SBC_cmd = DeclareLaunchArgument('SBC',default_value='false', description='Launch SBC (optional).')
    declare_PC_cmd = DeclareLaunchArgument('PC',default_value='false', description='Launch SBC (optional).')
    declare_PC2_cmd = DeclareLaunchArgument('PC2',default_value='false', description='Launch SBC (optional).')
    declare_MAP_cmd = DeclareLaunchArgument('MAP',default_value='false', description='Launch SBC (optional).')
    declare_NAV2_cmd = DeclareLaunchArgument('NAV2',default_value='false', description='Launch SBC (optional).')

    #DeclareLaunchArgument('qos', default_value='2', description='QoS used for input sensor topics'),
    declare_qos_cmd = DeclareLaunchArgument('qos', default_value='1', description='QoS used for input sensor topics')
    declare_localization_cmd = DeclareLaunchArgument('localization', default_value='false', description='Launch in localization mode.')
    declare_namespace_cmd = DeclareLaunchArgument('namespace', default_value='rtabmap', description='')

    declare_rviz_cmd = DeclareLaunchArgument('rviz',default_value='true', description='Launch RVIZ (optional).')
    #DeclareLaunchArgument('rviz_cfg', default_value=config_rviz,description='Configuration path of rviz2.'),
    declare_rviz_cfg_fox_nav2_cmd = DeclareLaunchArgument('rviz_cfg_fox_nav2', default_value=config_rviz_fox_nav2,description='Configuration path of rviz2.')

    declare_gps_cmd = DeclareLaunchArgument('gps',default_value='true', description='')

    declare_rate_cmd = DeclareLaunchArgument('rate',default_value='10', description='')
    declare_queue_size_cmd = DeclareLaunchArgument('queue_size',default_value='2', description='')
    declare_rgb2grey_cmd = DeclareLaunchArgument('rgb2grey',default_value='false', description='')


    declare_auto_exp_cmd = DeclareLaunchArgument('auto_exp', default_value = 'true')
    declare_sensIso_cmd  = DeclareLaunchArgument('sensIso', default_value = '1200')
    declare_expTime_cmd  = DeclareLaunchArgument('expTime', default_value = '28500')
    ...
    sbc_cmd_group = GroupAction(
        #condition=IfCondition(LaunchConfiguration('SBC')),
        condition=IfCondition(SBC),
    ...
    pc2_cmd_group =GroupAction(
        #condition=IfCondition(LaunchConfiguration('PC2')),
        condition=IfCondition(PC2),
        #condition=IfCondition(PythonExpression(["'",LaunchConfiguration('PC'), "' == 'true'"])),
        actions=[
            Node(
    ...
    ld.add_action(declare_PC_cmd)
    ld.add_action(declare_PC2_cmd)
    ...
    ld.add_action(declare_rviz_cfg_fox_nav2_cmd)

    ld.add_action(declare_gps_cmd)

    ld.add_action(declare_rate_cmd)
    ld.add_action(declare_queue_size_cmd)
    ld.add_action(declare_rgb2grey_cmd)

    ld.add_action(declare_auto_exp_cmd)
    ...
    ld.add_action(sbc_cmd_group)
    ld.add_action(map_cmd_group)
    ld.add_action(pc2_cmd_group)
